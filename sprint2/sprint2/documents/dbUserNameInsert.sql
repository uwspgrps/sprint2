...
VALUES ('adminTest', '$2y$10$GMqiMVQLeDaNCys3MowIdeJj1Bia4nnmHtf4k4o9V4egLMXjKbxZ2', 'adminTest@example.com', now(), 'admin', 'A'),
	   ('normalTest', '$2y$10$o1FaUz6bAnR4IFiJ/y8Y2.Lu4auPLJ6H2l/.Z.0n6aG1R1WnB/y0a', 'normalTest@example.com', now(), 'normal', 'A');
